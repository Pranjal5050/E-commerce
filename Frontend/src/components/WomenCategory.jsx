                                ...
                                "
                                    ...
                                    {prod ? (
                                        <button
                                            ...
                                            className=" rounded-sm hover:bg-green-900 hover:text-white border flex items-center justify-center gap-1 text-xs sm:text-sm cursor-pointer border-green-800 text-green-900 w-full py-2 transition
                                "
                                        >
                                        ...
                                        <Link to={"/cart"} className='rounded-sm hover:bg-green-900 hover:text-white border flex items-center justify-center gap-1 text-xs sm:text-sm cursor-pointer border-green-800 text-green-900 w-full py-2 transition'>
                                            Go to cart <RiShoppingBasketFill className="inline-block ml-1" />
                                        </Link>
                                    )}
                                </div>
                            </div>
