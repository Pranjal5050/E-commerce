...
const UserLogin = () => {
  ...
  return (
    <div className='w-full h-screen bg-gray-100 flex'>
      ...
      {/* Left */}
      <div className='hidden md:block w-1/3 h-screen bg-green-50 p-10'>
        <div className=''>
      ...
      <div className='w-full h-screen bg-gray-100 flex items-center justify-center'>
        <div className='w-full h-full md:w-[90%] md:h-[90%] bg-white rounded shadow-md p-5'>
          ...
          <div className='text-center'>
            ...
            <h1 className='text-2xl mt-2 mb-1'>Welcome Back</h1>
          ...
          <form onSubmit={onSubmitHandaler}>
            <div className='w-full mt-10'>
              ...
              <p className='text-sm text-center mt-2'>Dan't have an account? <Link to={'/register'} className="text-green-600">register</Link></p>
            </div>
          </form>
